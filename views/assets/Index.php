...
<body>
    ...
    <div id="main">
      <div class="contenedorNav">
        <button id="AbrirNav" class="BotonNav" onclick="Abrir_Nav()"> <i class="fa-solid fa-house fa-beat-fade fa-2xl"
            style="color: #faa0fc;"></i> </button> <!-- lineas horizonrales  &#9776-->
      </div>
    </div>


    <!--   <img src="img/Fondo.jpg" alt="fondo" style="width: 2000px; height: 700px; opacity: 0.7;">-->
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          <div class="item active">
            <img src="img/c1.jpg" alt="Los Angeles" style="width:45%;">
          </div>

          <div class="item">
            <img src="img/c2.jpg" alt="Chicago" style="width:45%;">
          </div>

          <div class="item">
            <img src="img/c3.jpg" alt="New york" style="width:45%;">
          </div>
        </div>
